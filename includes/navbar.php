<!-- Nav Bar -->
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top glassy-nav">
      <div class="container">
        <a class="navbar-brand fw-bold" href="/Dinura_Project_001-German-Travelers/pages/home/">TULA REISEN</a>
          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-3">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#">Translate to another Language</a></li>
              </ul>
            </li>
          </ul>
          <div class="d-flex">
            <button class="button-51" role="button"><span>Log In</span></button>
          </div>
        </div>
      </div>
    </nav>